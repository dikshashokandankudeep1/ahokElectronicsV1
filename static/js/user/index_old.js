...
window.onload = function() {
    ...
    hideId('ChangePassword_onClick');

    //funcOnClickSubHeading("ProfileInformation");

    hideId('editDelete');
    funcOnClickSubHeading("ManageAddresses");
...
function funcOnClickSubHeading(idType) {
    if ('ProfileInformation' == idType) {
        ...
        showId('ProfileInformation_onClick');
        hideId('ProfileInformation_def');

        hideId('ManageAddresses');
        showId('ManageAddresses_def');
        hideId('ManageAddresses_onClick');

        hideId('ChangePassword');
        showId('ChangePassword_def');
        hideId('ChangePassword_onClick');

    } else if ('ManageAddresses' == idType) {
        hideId('ProfileInformation');
        showId('ProfileInformation_def');
        hideId('ProfileInformation_onClick');

        hideId('ChangePassword');
        showId('ChangePassword_def');
        hideId('ChangePassword_onClick');

        showId('ManageAddresses');
        hideId('ManageAddresses_def');
        showId('ManageAddresses_onClick');

    } else if ('ChangePassword' == idType) {
        hideId('ProfileInformation');
        showId('ProfileInformation_def');
        hideId('ProfileInformation_onClick');
        ...
        showId('ChangePassword');
        hideId('ChangePassword_def');
        showId('ChangePassword_onClick');
